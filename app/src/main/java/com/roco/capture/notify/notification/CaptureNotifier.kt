package com.roco.capture.notify.notification
...
class CaptureNotifier(
    ...
    fun monitorNotification(state: CaptureTaskState): Notification {
        ...
        return baseBuilder(NotificationChannels.MONITOR_STATUS)
            ...
            .setContentTitle("洛克捕获提醒：${state.status.label}")
            .setContentText(text)
            .setOngoing(state.status != com.roco.capture.notify.model.TaskStatus.Paused)
            .build()
    }
